...
<p align="center">
  <img src="https://raw.githubusercontent.com/yuri-schmaltz/mint-install-pro/master/public/icons/mint-install-pro.svg" alt="Mint Install Pro Logo" width="96" height="96">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/yuri-schmaltz/mint-install-pro/releases/tag/v1.5.2"><img src="https://img.shields.io/badge/Release-v1.5.2%20.deb-blue?style=flat-square&logo=debian" alt="Download .deb"></a>
...
1. **Baixe o arquivo `.deb` mais recente:**
   ```bash
   wget https://github.com/yuri-schmaltz/mint-install-pro/releases/download/v1.5.2/mint-install-pro_1.5.2_all.deb
   ```
