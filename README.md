...
<p align="center">
  ...
  <a href="https://github.com/yuri-schmaltz/mint-install-pro/releases/tag/v1.5.5"><img src="https://img.shields.io/badge/Release-v1.5.5%20.deb-blue?style=flat-square&logo=debian" alt="Download .deb"></a>
...
1. **Baixe o arquivo `.deb` mais recente:**
   ```bash
   wget https://github.com/yuri-schmaltz/mint-install-pro/releases/download/v1.5.5/mint-install-pro_1.5.5_all.deb
   ```
